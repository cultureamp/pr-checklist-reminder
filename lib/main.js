    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            for (const spec of specs) {
                ...
                yield createGithubStatus({ pullRequest, client, spec, statusContext });
                i++;
            }
        }
        catch (error) {
...
function createGithubStatus({ pullRequest, client, spec, statusContext }) {
    return __awaiter(this, void 0, void 0, function* () {
...
function makeWhitelistFromArgs(args) {
    ...
    const reducer = (accumulator, argKey) => {
...
exports.makeWhitelistFromArgs = makeWhitelistFromArgs;
run();
